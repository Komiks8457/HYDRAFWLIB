...
namespace MachineManager
{
    ...
    {
        MEMUTIL_VFTABLE_HOOK(0x015650E4, 7, &CMainProcess::PrepareMsgHandlers);
        MEMUTIL_VFTABLE_HOOK(0x015650E4, 8, &CMainProcess::RegisterMsgHandler);
    ...
    BOOL CMainProcess::PrepareMsgHandlers()
    {
        ...
        return reinterpret_thiscall(0x01478380, BOOL, this);
    }

    BOOL CMainProcess::RegisterMsgHandler(WORD wMsgID, uintptr_t fnPtr)
    {
        return reinterpret_thiscall(0x01490F40, BOOL, this, wMsgID, fnPtr);
    }

    BOOL CMainProcess::HandleMsg(CMsg *pMsg, DWORD dwOverlappedID, void *lpParam, CMassiveMsg *pMassiveMsg)
    {
