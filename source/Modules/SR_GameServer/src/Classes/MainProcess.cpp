...
{
    DWORD OnHandleMsg_returnAddress = 0x00BDFC15;
    ...
    {
        MEMUTIL_VFTABLE_HOOK(0x00DAFF34, 7, &CMainProcess::PrepareMsgHandlers);
        MEMUTIL_VFTABLE_HOOK(0x00DAFF34, 8, &CMainProcess::RegisterMsgHandler);
        ...
        MEMUTIL_SETUP_HOOK(LongJump, 0x00BDFC10, OnHandleMsg);
    }
    ...
    BOOL CMainProcess::PrepareMsgHandlers()
    {
        ...
        return reinterpret_thiscall(0x00487170, BOOL, this);
    }

    BOOL CMainProcess::RegisterMsgHandler(WORD wMsgID, uintptr_t fnPtr)
    {
        return reinterpret_thiscall(0x00BDF740, BOOL, this, wMsgID, fnPtr);
    }
    ...
    BOOL CMainProcess::CustomMsg(CMsg *pMsg, DWORD, LPVOID, CMassiveMsg*)
    {
        ...
        switch (wMsgID) {
            ...
            default: {
                ...
                reinterpret_cdecl(0x00BE6430, char*, buffer, pMsg);
