...
namespace FarmManager
{
    ...
    {
        MEMUTIL_VFTABLE_HOOK(0x01529AFC, 7, &CMainProcess::PrepareMsgHandlers);
        MEMUTIL_VFTABLE_HOOK(0x01529AFC, 8, &CMainProcess::RegisterMsgHandler);
        MEMUTIL_VFTABLE_HOOK(0x01529AFC, 9, &CMainProcess::HandleMsg);
    }
    ...
    BOOL CMainProcess::PrepareMsgHandlers()
    {
        ...
        return reinterpret_thiscall(0x01441410, BOOL, this);
    }

    BOOL CMainProcess::RegisterMsgHandler(WORD wMsgID, uintptr_t fnPtr)
    {
        return reinterpret_thiscall(0x0144F550, BOOL, this, wMsgID, fnPtr);
    }
    ...
    BOOL CMainProcess::HandleMsg(CMsg *pMsg, DWORD a3, LPVOID a4, CMassiveMsg *pMassiveMsg)
    {
        ...
        return reinterpret_thiscall(0x014501A0, BOOL, this, pMsg, a3, a4, pMassiveMsg);
    }
        ...
        if (pMsg) {
            switch (pMsg->GetMsgID()) {
                ...
                default: {
                    ...
                    reinterpret_cdecl(0x014563E0, char*, buffer, pMsg);
